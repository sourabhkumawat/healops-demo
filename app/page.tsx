      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
            Professional demonstration of HealOps OpenTelemetry SDK integration.
            Trigger sample errors and see how they're automatically captured and sent to HealOps.
          </p>
        </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-zinc-800/50">
                ...
                <div>
                  ...
                  <p className="text-sm font-mono text-zinc-100 mt-1">{serviceName}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-lg bg-zinc-800/50">
                <Zap className="h-5 w-5 text-yellow-500" />
                <div>
                  <p className="text-xs text-zinc-400">SDK Version</p>
                  <p className="text-sm font-mono text-zinc-100 mt-1">{sdkVersion}</p>
                </div>
              </div>
            </div>
          </DemoCard>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <DemoCard
            ...
            description="Click the buttons below to trigger different types of errors. All errors are automatically captured by HealOps OpenTelemetry SDK."
            delay={0.4}
          >
            <ErrorButtons />
          </DemoCard>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <DemoCard
              ...
              description="JavaScript errors are automatically captured and sent to HealOps"
              delay={0.6}
            >
              <div className="space-y-2 text-sm text-zinc-400">
                <p>✓ Unhandled exceptions</p>
                <p>✓ API route errors</p>
            ...
            <DemoCard
              ...
              description="Track failed API requests and database errors"
              delay={0.7}
            >
              <div className="space-y-2 text-sm text-zinc-400">
                <p>✓ HTTP error responses</p>
        ...
        >
          <p>
            ...
            <span className="text-green-500 font-semibold">HealOps OpenTelemetry SDK</span>
          </p>
        </motion.div>
      </div>
    </div>
